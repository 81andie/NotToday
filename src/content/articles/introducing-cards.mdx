---
title: Tributo a Jaqen H'ghar y Arya Stark
...
export const components = {
  Container: props => <div class="flex flex-row-reverse justify-center w-full my-12 flex-wrap lg:flex-nowrap gap-2 mt-5" {...props} />,
  HoloText: props => <p class="text-center holographic-text font-display mt-2 text-xl lg:text-4xl" {...props} />
}
...
<HoloText>Quién Jaqen H'ghar?</HoloText>
